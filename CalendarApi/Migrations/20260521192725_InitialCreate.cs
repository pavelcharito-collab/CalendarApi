        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recurrence_Frequency = table.Column<string>(type: "TEXT", nullable: true),
                    Recurrence_Interval = table.Column<int>(type: "INTEGER", nullable: true),
                    Recurrence_Until = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    Recurrence_Count = table.Column<int>(type: "INTEGER", nullable: true),
